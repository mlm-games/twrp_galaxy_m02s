...
So if anyone else has also tried, pls open an issue, i'll just remove the text after some clarity (and once pls read the issue referred to above before trying)
